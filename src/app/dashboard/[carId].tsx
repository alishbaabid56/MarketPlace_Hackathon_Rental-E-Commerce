...
//               { icon: <FaCar />, text: "Car Rent" },
//               { icon: <FaChartBar />, text: "Insight" },
//               { icon: <FaWallet />, text: "Reimburse" },
//               { icon: <FaInbox />, text: "Inbox" },
//               { icon: <FaCalendarAlt />, text: "Calendar" },
//             ].map((item, index) => (
//               <li 
//                 key={index}
//                 className={`flex items-center space-x-2 text-lg p-3 rounded-lg transition-colors ${
//                   theme === 'dark' 
...
//               { icon: <FaQuestionCircle />, text: "Help & Center" },
//               { icon: theme === 'dark' ? <FaSun /> : <FaMoon />, text: theme === 'dark' ? "Light Mode" : "Dark Mode" },
//             ].map((item, index) => (
//               <li 
//                 key={index}
//                 className={`flex items-center space-x-2 text-lg p-3 rounded-lg transition-colors cursor-pointer ${
//                   theme === 'dark' 
//                     ? 'hover:bg-gray-700 text-gray-300' 
//                     : 'hover:bg-gray-100 text-gray-700'
//                 }`}
//                 onClick={() => {
//                   if (index === 2) {
//                     toggleTheme(); // Toggle theme for Light/Dark Mode
//                   }
//                 }}
//               >
//                 {item.icon}
...
//             ))}
//           </ul>
//           <button className={`mt-6 text-lg w-full p-3 rounded-lg transition-colors ${
//             theme === 'dark' 
...
//                       width={60} 
//                       height={40}
//                       className={theme === 'dark' ? 'filter brightness-90' : ''}
//                     />
//                     <span>{item.name}</span>
